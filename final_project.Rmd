...
---
<font size = 6>Group Members:<br></font>
<font size = 4>周广瑜 2019100442<br></font>
<font size = 4>董璐瑶 2019102470<br></font>
```{r}
...
<font size = 5>
Get Tushare Data<br></font>
<font size = 4>
SSE Composite Index</font>
```{r message=FALSE, warning=FALSE, paged.print=FALSE}
...
#SSE 50 Constituents
SSE50_constituents <- read.csv("C:/Users/Administrator/Desktop/R_final_project-master/000016closeweight.csv")
...
```
<font size = 5>Draw figures<br></font>
<font size = 4>Plot candlestick</font>
```{r}
...
```
<font size = 4><br>Plot SSE50 constituents maps</font>
```{r}
...
ggplot(SSE50, aes(area = mv, label = names)) +
  ...
  ggtitle("上证50成分股涨跌情况")
```
<font size = 4><br>Generate the screener overview</font>
```{r}
...
```
<font size = 4><br>Generate the line graph of individual stock</font>
```{r}
